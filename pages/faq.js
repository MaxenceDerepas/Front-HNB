...
export async function getStaticProps() {
    ...
    await dbConnect();
    const data = await Description.findOne({ page: "FAQ" }).lean();
            ...
            <section className={styles.content}>
                ...
                <div className={styles.container}>
                    ...
                    <p className={styles.text}>
                        ...
                        soumet une proposition de parcours vous indiquant :
                    </p>
                    <ul className={styles.list}>
                        <li>Le nombre de séances de coaching nécessaires</li>
                        <li>
                    ...
                    <p className={styles.text}>
                        Chaque séance de coaching se déroule en 4 temps. Pour en
                        savoir plus sur le déroulé,{" "}
                    ...
                    <p className={styles.text}>
                        Des séances d’accompagnement ad hoc peuvent également
                        vous être proposées en complément de vos séances de
                        coaching. Elles permettent par exemple de travailler sur
                        un enjeu imminent comme une prise de parole spécifique.
                    </p>
                    <p className={styles.text}>
                        Chaque parcours de coaching donne lieu à une séance de
                        synthèse qui permet d’évaluer l’évolution de votre
                        niveau d’aisance en anglais professionnel.
                    </p>
                    <p className={styles.text}>
                        Enfin, la séance de suivi d’1h environ 3 mois après la
                        synthèse permet de confirmer les acquis.
                    </p>
                    ...
                    <ul className={styles.list}>
                        <li>
                            ...
                            l’échelle de confiance après environ 10 séances d’1h
                            de coaching{" "}
                    ...
                    <p className={styles.text}>
                        Les séances de coaching sont à régler par virement
                        bancaire, généralement après la 1ère séance de coaching.
                        <br />
                        Nous proposons des facilités de paiement pour les
                        particuliers (règlement en 2 ou 3 fois sans frais).
                        <br />
                        Nos accompagnements sont éligibles au CPF,
                    ...
                    <p className={styles.text}>
                        ...
                        <br />
                        Il s’agit d’une expérience personnalisée visant à
                        renforcer des compétences clés et à stimuler la
